...
# Title: Modulador_AM _G5
# Author: Camila Nicolas
# Copyright: UIs
...
from Modulador_AM_Jherson import Modulador_AM_Jherson  # grc-generated hier_block
...
class Generador_modulador_amplitud(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Modulador_AM _G5", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulador_AM _G5")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Generador_modulador_amplitud")
        ...
        self._Fm_range = Range(0, 2000000, 100, 1000000, 200)
        ...
        self.Modulador_AM_Jherson_0 = Modulador_AM_Jherson(
            Ac=Ac,
            Ka=Ka,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Modulador_AM_Jherson_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.Modulador_AM_Jherson_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Modulador_AM_Jherson_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Modulador_AM_Jherson_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Modulador_AM_Jherson_0, 0))
    ...
    def set_Ka(self, Ka):
        self.Ka = Ka
        self.Modulador_AM_Jherson_0.set_Ka(self.Ka)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Modulador_AM_Jherson_0.set_Ac(self.Ac)




def main(top_block_cls=Generador_modulador_amplitud, options=None):
