...
class practica2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._fc_range = Range(50e6, 1e9, 100, 100e6, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "freq", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._GTX_range = Range(0, 30, 1, 1, 200)
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganancia", "counter_slider", float, QtCore.Qt.Horizontal)
