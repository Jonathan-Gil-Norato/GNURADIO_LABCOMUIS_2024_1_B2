...
class Modulacion_pm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._Kp_range = Range(0, 100, 1e-6, 1, 200)
        self._Kp_win = RangeWidget(self._Kp_range, self.set_Kp, "Indice sensibilidad", "counter_slider", float, QtCore.Qt.Horizontal)
