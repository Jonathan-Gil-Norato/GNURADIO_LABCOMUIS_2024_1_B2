...
# Title: Demodulación de emisoras
...
class ModulacionFMRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Demodulación de emisoras", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demodulación de emisoras")
        ...
        self._Fc_range = Range(88e6, 220e6, 100e3, 90.7e6, 200)
        self._Fc_win = RangeWidget(self._Fc_range, self.set_Fc, "Frecuencia carry", "counter_slider", float, QtCore.Qt.Horizontal)
