...
class PruebaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Fs_win = RangeWidget(self._Fs_range, self.set_Fs, "Frecuencia Pulsos [Hz]", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._D3_range = Range(0, 100, 1, 10, 200)
        self._D3_win = RangeWidget(self._D3_range, self.set_D3, "Retardo señal 4", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D3_win)
        self._D2_range = Range(0, 100, 1, 10, 200)
        self._D2_win = RangeWidget(self._D2_range, self.set_D2, "Retardo señal 3", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D2_win)
        self._D1_range = Range(0, 100, 1, 10, 200)
        self._D1_win = RangeWidget(self._D1_range, self.set_D1, "Retardo señal 2", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D1_win)
        self._D_range = Range(0, 50, 1, 10, 200)
        self._D_win = RangeWidget(self._D_range, self.set_D, "Ancho pulsos [%] Ciclo Util", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self.connect((self.ModulacionPAM_0_1, 0), (self.blocks_delay_0_0_0, 0))
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.ModulacionPAM_0_2, 0))
