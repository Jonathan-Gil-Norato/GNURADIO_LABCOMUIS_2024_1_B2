...
class lab_comu_I_Tutorial(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab_comu_I_Tutorial")
        ...
        self._f_corte_win = RangeWidget(self._f_corte_range, self.set_f_corte, "freciuencia de corte", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._f_corte_win)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Descargas/Audios de prueba-20221024T181737Z-001/Audios de prueba/session52_quevedobzrp.wav', True)
...
def main(top_block_cls=lab_comu_I_Tutorial, options=None):
