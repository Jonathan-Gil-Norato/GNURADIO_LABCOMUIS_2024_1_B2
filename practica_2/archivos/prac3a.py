...
class prac3a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/comu2_b2/comujon/GNURADIO_LABCOMUIS_2024_1_B2/practica_2/archivos/sonido.wav', True, 0, 0)
