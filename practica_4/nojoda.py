...
import math
import nojoda_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class nojoda(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "nojoda")
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(math.pi*2/M)
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.b_PSD_c_0, 0))
    ...
    def set_M(self, M):
        ...
        self.blocks_multiply_const_vxx_0.set_k(math.pi*2/self.M)
...
def main(top_block_cls=nojoda, options=None):
