...
class Constelacion(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Sps = Sps = len(H)
        self.Rs = Rs = rb/Nbs
        self.cons = cons = (1+0j, 0.707+0.707j, 0+1j, -0.707+0.707j, -1+0j, -0.707-0.707j, 0-1j, 0.707-0.707j)
        ...
        # Blocks
        ##################################################
        self._N_range = Range(0, 2, 0.01, 0.1, 200)
        self._N_win = RangeWidget(self._N_range, self.set_N, "'N'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_ic(cons, 1)
        self.blocks_vector_source_x_0 = blocks.vector_source_i((0,1,2,3,4,5,6,7), True, 1, [])
    ...
    def set_cons(self, cons):
        self.cons = cons
        self.digital_chunks_to_symbols_xx_0.set_symbol_table(self.cons)
